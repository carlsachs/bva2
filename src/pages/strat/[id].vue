                ...
                <div>
                    ...
                    <div class="text-xl text-cyan-200">
                        <div class="text-center p-5 m-6 flex flex-row items-center justify-center p-2 space-x-5 mb-5">
                            ...
                            <a href="email:bitcoinvsalts@gmail.com" class="text-green-500 font-bold" target="_new"><img class="mx-auto" width=34 alt="GitHub" src="/email.png"/></a> &nbsp;

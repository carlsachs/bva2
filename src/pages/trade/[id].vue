  ...
  <div>
    ...
    <div ref="myEl" class="mx-2 my-14 py-4 border-2 border-blue-900 rounded-lg text-white relative">
      ...
      <div class="p-4 grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-1 sm:gap-5 uppercase">
        ...
        <div v-if="buy_price" class="group flex items-center bg-opacity-40 shadow-xl gap-5 px-6 py-5 rounded-lg ring-2 ring-offset-2 ring-offset-blue-800 ring-cyan-700 mt-5 transition">
            <div class="flex-auto">Buy Price</div>
            <div class="flex-auto text-justify text-blue-300 block">{{ buy_price }}</div>
        </div>

        <div v-if="sell_price" class="group flex items-center bg-opacity-40 shadow-xl gap-5 px-6 py-5 rounded-lg ring-2 ring-offset-2 ring-offset-blue-800 ring-cyan-700 mt-5 transition">
            <div class="flex-auto">Sell Price</div>
            <div class="flex-auto text-justify text-blue-300 block">{{ sell_price }}</div>
        </div>

        <div v-if="buy_time" class="group flex items-center bg-opacity-40 shadow-xl gap-5 px-6 py-5 rounded-lg ring-2 ring-offset-2 ring-offset-blue-800 ring-cyan-700 mt-5 transition">
        ...
        <div v-if="sell_time" class="group flex items-center bg-opacity-40 shadow-xl gap-5 px-6 py-5 rounded-lg ring-2 ring-offset-2 ring-offset-blue-800 ring-cyan-700 mt-5 transition">
        ...
        <div v-if="status" class="group flex items-center bg-opacity-40 shadow-xl gap-5 px-6 py-5 rounded-lg ring-2 ring-offset-2 ring-offset-blue-800 ring-cyan-700 mt-5 transition">
            <div class="flex-auto">Status</div>
            <div class="flex-auto text-justify text-blue-300 block">{{ status }}</div>
        </div>

        <div v-if="market_type" class="group flex items-center bg-opacity-40 shadow-xl gap-5 px-6 py-5 rounded-lg ring-2 ring-offset-2 ring-offset-blue-800 ring-cyan-700 mt-5 transition">
            <div class="flex-auto">Type</div>

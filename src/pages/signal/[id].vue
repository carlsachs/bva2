                ...
                if (state.signal_type === 'LONG') {
                  ...
                  if (sum_sell_trade_size) {
                    if (signal.data[0]?.sell_trade_size_4) {
                      ...
                      state.pnl = Number(last_price.minus(dca_buy_price).div(dca_buy_price).div(sum_buy_trade_size).minus(0.2).toFixed(2))
                  }
                  else {
                  ...
                  if (sum_buy_trade_size) {
                    if (signal.data[0]?.buy_trade_size_4) {
                      ...
                      state.pnl = Number(dca_sell_price.minus(last_price).div(last_price).div(sum_sell_trade_size).minus(0.2).toFixed(2))
                  }
                  else {
